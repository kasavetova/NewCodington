...
<title>Codington Museum</title>
<link rel="stylesheet" type="text/css" href="css/codington.css">
</head>
<body topmargin="2">
<form method="post" action="MuseumServlet">
			...
			<tr>
				...
				<table>
					<tr>
						...
						<table>
							<tr>
								<td style="font-weight: bold">North Town Natural History
								Museum</td>
							</tr>
							<tr>
								<td></td>
							...
							<tr>
								<td><img src="/NewCodingtonAdminPortal/images/museum.jpg"
									alt="Museum" height="250" width="600"></td>
							</tr>
							<tr>
								<td align="right"><input type="submit"
									value="CLick for Displaying all Events for Museum"></input></td>
							</tr>
						</table>
						</td>
					</tr>
