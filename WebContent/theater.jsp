...
<title>Codington Theater</title>
<link rel="stylesheet" type="text/css" href="css/codington.css">
</head>
<body topmargin="2">
<form method="post" action="TheaterServlet">
			...
			<tr>
				...
				<table>
					<tr>
						...
						<table>
							<tr>
								<td style="font-weight: bold">North Town Jade Theater</td>
							</tr>
							<tr>
								<td></td>
							</tr>
							<tr>
								<td><img src="/NewCodingtonAdminPortal/images/Theater.jpg"
									alt="Theater" height="250" width="600"></td>
							</tr>
							<tr>
								<td align="right"><input type="submit"
									value="CLick for Displaying all Events for Theater"></input></td>
							</tr>
						</table>
						</td>
					</tr>
